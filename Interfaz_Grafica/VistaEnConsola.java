public class VistaEnConsola implements Observador{
    ...
    public void actualizar(Cuadrantes cuadrantes){ //mostrar en pantalla todos los gatos
        ...
        System.out.print(" " + cuadrantes.getCuadrante(0,1).getGato()[0][0] + " | " + cuadrantes.getCuadrante(0,1).getGato()[0][1]+ " | " + cuadrantes.getCuadrante(0,1).getGato()[0][2] + "  || ");
        ...
        System.out.println(" " + cuadrantes.getCuadrante(0,2).getGato()[1][0] + " | " + cuadrantes.getCuadrante(0,2).getGato()[1][1] + " | " + cuadrantes.getCuadrante(0,2).getGato()[1][2] + " ");
        System.out.println("___|___|___ || ___|___|___ || ___|___|___");
        System.out.print(" " + cuadrantes.getCuadrante(0,0).getGato()[2][0] + " | " + cuadrantes.getCuadrante(0,0).getGato()[2][1] + " | " + cuadrantes.getCuadrante(0,0).getGato()[2][2] + "  || ");
